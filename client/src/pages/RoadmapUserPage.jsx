 ...
 <div style={{display:'flex',flexDirection:'row'}}>
  <Box sx={{ml:30,mt:15}}>
   ...
   <Box sx={{color:'white',ml:30,mt:15,maxWidth:600}}>
      ...
      <Typography variant='h6' sx={{fontWeight:'bolder',textAlign:'center',mt:1.5, letterSpacing:5}}>roadmap</Typography>
      </div>
      <div>
        ...
        <Typography sx={{mt:5, letterSpacing:2}} variant='h6'>
          Para editar tu roadmap , asegurate de mantener actualizado tu registro de materias faltantes por cursar.
        </Typography>
      </div>
   </Box>
 </div>
